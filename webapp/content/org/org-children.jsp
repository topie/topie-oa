...
-->
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small a-insert btn-default" onclick="location.href='org-inputChild.do?partyStructTypeId=${partyStructTypeId}&partyEntityId=${partyEntityId}'">新建</button>
