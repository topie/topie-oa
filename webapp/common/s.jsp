<%@page language="java" pageEncoding="UTF-8" %>
    ...
    <!-- html5 -->
    <!--[if lt IE 9]>
    <link rel="stylesheet" type="text/css" href="${ctx}/s.topie/css/ie.css" media="screen" />
    ...
    <!-- layout -->
    <script type="text/javascript" src="${ctx}/s.topie/js/hideshow.js"></script>
    <script type="text/javascript" src="${ctx}/s.topie/js/jquery.equalHeight.js"></script>
    <script type="text/javascript" src="${ctx}/s.topie/js/table.js"></script>
	...
	<!-- layout -->
    <link type="text/css" rel="stylesheet" href="${ctx}/s.topie/css/layout3.css" media="screen" />
