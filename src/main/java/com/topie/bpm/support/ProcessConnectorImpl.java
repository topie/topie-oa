...
import com.topie.bpm.cmd.FindFirstTaskFormCmd;
...
import com.topie.spi.process.FirstTaskForm;
...
public class ProcessConnectorImpl implements ProcessConnector {
    ...
    public FormDTO findStartForm(String processDefinitionId) {
        ...
        if ((!firstTaskForm.isExists())
            ...
            // 再从数据库里找一遍配置
            com.topie.spi.humantask.FormDTO humantaskFormDto = taskDefinitionConnector
