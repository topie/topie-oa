...
import com.topie.model.support.FormField;

import com.topie.pim.persistence.manager.PimDeviceManager;

import com.topie.xform.Xform;
import com.topie.xform.XformBuilder;
...
public class AndroidFormResource {
    ...
    public String viewStartForm(
        ...
        buff.append("<xmlgui>")
                .append("<form id='1' name='form' submitTo='http://192.168.1.106:8080.topie-app-lemon/rs/android/bpm/startProcess' >");
    ...
    public String viewTaskForm(@FormParam("taskId") String taskId)
        ...
        buff.append("<xmlgui>")
                .append("<form id='1' name='form' submitTo='http://192.168.1.106:8080.topie-app-lemon/rs/android/task/completeTask' >");
