...
INSERT INTO AUTH_MENU(ID,TYPE,CODE,TITLE,URL,PRIORITY,PARENT_ID,PERM_ID) VALUES(306,'module','device','设备管理','/user/account-attendance-list.do',306,31,306);
...
INSERT INTO AUTH_MENU(ID,TYPE,CODE,TITLE,URL,PRIORITY,PARENT_ID,PERM_ID) VALUES(712,'module','attendance','考勤管理','/user/account-attendance-list.do',712,71,712);
