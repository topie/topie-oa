...
INSERT INTO AUTH_PERM_TYPE(ID,NAME,TYPE,PRIORITY,TENANT_ID) VALUES(31,'权限管理',0,31,'1');
...
INSERT INTO AUTH_PERM(ID,CODE,NAME,PERM_TYPE_ID,TENANT_ID) VALUES(301,'sys_user','权限管理',31,'1');
...
INSERT INTO AUTH_MENU(ID,TYPE,CODE,TITLE,URL,PRIORITY,PARENT_ID,PERM_ID) VALUES(31,'system','user','权限管理','/user/account-info-list.do',31,21,301);
